...
function LoginForm() {
  ...
  function fillDemo() {
    setEmail("demo@acmebuilding.com.au");
      ...
      >
        ...
        <div className="bg-white rounded-3xl border border-aw-gray-border shadow-xl shadow-black/5 p-8">
          ...
          <button
            type="button"
            onClick={fillDemo}
            className="w-full mb-5 flex items-center justify-between rounded-2xl border border-dashed border-aw-green/40 bg-aw-green-light/50 px-4 py-3 text-sm font-semibold text-aw-green hover:bg-aw-green-light transition-colors"
          >
            <span>🧪 Use demo account</span>
            <span className="text-xs font-medium text-aw-green/70">demo@acmebuilding.com.au</span>
          </button>
